...
public class HorizonEvokeParticleSpiralHeavy extends AbstractGameEffect {
    ...
    public HorizonEvokeParticleSpiralHeavy(float x, float y) {
        ...
        this.vR = MathUtils.random(-75.0F, -100.0F);
    ...
    public void update() {
        ...
        this.rotation += this.vR * Gdx.graphics.getDeltaTime();
         ...
         if (this.duration > this.dur_div2) {
            this.color.a = Interpolation.fade.apply(0.3F, 0.0F, (this.duration - this.dur_div2) / this.dur_div2);
        } else {
            this.color.a = Interpolation.fade.apply(0.0F, 0.3F, this.duration / this.dur_div2);
        }
