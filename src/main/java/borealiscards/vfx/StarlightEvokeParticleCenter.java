...
public class StarlightEvokeParticleCenter extends AbstractGameEffect {
    ...
    public StarlightEvokeParticleCenter(float x, float y) {
        ...
        this.y = y + MathUtils.random(-20.0F, -20.0F) * Settings.scale;
        this.x = x + MathUtils.random(-20.0F, -25.0F) * Settings.scale;
