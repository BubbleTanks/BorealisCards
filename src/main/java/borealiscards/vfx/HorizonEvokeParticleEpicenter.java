...
public class HorizonEvokeParticleEpicenter extends AbstractGameEffect {
    ...
    public static Texture EPICENTER_IMG = TextureLoader.getTexture("borealiscards/images/vfx/horizon_epicenter.png");
            // ImageMaster.INTENT_ESCAPE_L;

            //

    public HorizonEvokeParticleEpicenter(float x, float y) {
        this.img = EPICENTER_IMG;
        this.duration = 1.0F;
        this.scale = MathUtils.random(5.0F, 5.0F) * Settings.scale;
        this.dur_div2 = this.duration / 2.0F;
        this.color = Color.WHITE.cpy();
        this.color.a = 0.0F;
        this.renderBehind = false;
        this.rotation = MathUtils.random(0.0F, 0.0F);
