...
public class StarlightParticle extends AbstractGameEffect {
    ...
    public StarlightParticle(float x, float y) {
        this.img = ImageMaster.TINY_STAR;
        this.duration = MathUtils.random(1.7F, 2.2F);
        ...
        this.y = y + MathUtils.random(-55.0F, -40.0F) * Settings.scale;
        this.x = x + MathUtils.random(-65.0F, -45.0F) * Settings.scale;
        vX = MathUtils.random(30.0F, 35.0F) * Settings.scale;
        vY = MathUtils.random(5.0F, 10.0F) * Settings.scale;
