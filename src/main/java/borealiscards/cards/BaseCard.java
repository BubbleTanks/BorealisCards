...
import borealiscards.util.TriFunction;
...
import static borealiscards.util.GeneralUtils.removePrefix;
import static borealiscards.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return BorealisCards.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    BorealisCards.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
