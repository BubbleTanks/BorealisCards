...
public class BurningMontantePower extends BasePower implements OnCreateCardInterface {
    ...
    private void updateCards() {
        ...
        }}) if(c.type == AbstractCard.CardType.ATTACK && c.cost >= 2 && !CardModifierManager.hasModifier(c, BurningMontanteMod.ID) && AbstractDungeon.player.hasPower(BurningMontantePower.POWER_ID)) CardModifierManager.addModifier(c, new BurningMontanteMod());
    }
