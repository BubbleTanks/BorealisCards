...
public class CardBorderPatch {
    ...
    @SpirePatch2(clz = CustomCard.class, method = "setDisplayRarity")
    public static class CustomDisplayRarity {
        ...
        @SpirePrefixPatch
        public static void setImages(AbstractCard.CardRarity rarity, CustomCard __instance) {

            if (rarity == CustomRarity.SHOP) {
                __instance.bannerSmallRegion = shopBannerAtlas;
                __instance.bannerLargeRegion = shopBannerAtlasL;
                switch (__instance.type) {
                    case ATTACK:
                        __instance.frameSmallRegion = shopAttackAtlas;
                        __instance.frameLargeRegion = shopAttackAtlasL;
                        break;
                    case POWER:
                        __instance.frameSmallRegion = shopPowerAtlas;
                        __instance.frameLargeRegion = shopPowerAtlasL;
                        break;
                    default:
                        __instance.frameSmallRegion = shopSkillAtlas;
                        __instance.frameLargeRegion = shopSkillAtlasL;
                }

                __instance.frameMiddleRegion = shopCenterAtlas;
                __instance.frameLeftRegion = shopLeftAtlas;
                __instance.frameRightRegion = shopRightAtlas;
                __instance.frameMiddleLargeRegion = shopCenterAtlasL;
                __instance.frameLeftLargeRegion = shopLeftAtlasL;
                __instance.frameRightLargeRegion = shopRightAtlasL;
            }
            if (rarity == CustomRarity.EXOTIC) {
                __instance.bannerSmallRegion = exoticBannerAtlas;
                __instance.bannerLargeRegion = exoticBannerAtlasL;
                switch (__instance.type) {
                    case ATTACK:
                        __instance.frameSmallRegion = exoticAttackAtlas;
                        __instance.frameLargeRegion = exoticAttackAtlasL;
                        break;
                    case POWER:
                        __instance.frameSmallRegion = exoticPowerAtlas;
                        __instance.frameLargeRegion = exoticPowerAtlasL;
                        break;
                    default:
                        __instance.frameSmallRegion = exoticSkillAtlas;
                        __instance.frameLargeRegion = exoticSkillAtlasL;
                }

                __instance.frameMiddleRegion = exoticCenterAtlas;
                __instance.frameLeftRegion = exoticLeftAtlas;
                __instance.frameRightRegion = exoticRightAtlas;
                __instance.frameMiddleLargeRegion = exoticCenterAtlasL;
                __instance.frameLeftLargeRegion = exoticLeftAtlasL;
                __instance.frameRightLargeRegion = exoticRightAtlasL;
            }
        }
    }
